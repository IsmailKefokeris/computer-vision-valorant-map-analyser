...
"")
        ...
        font7 = QFont()
        font7.setFamilies([u"Cascadia Mono ExtraLight"])
        font7.setPointSize(10)
        font7.setItalic(False)
        font7.setUnderline(False)
        font7.setStyleStrategy(QFont.PreferAntialias)
        self.ppuidLabel.setFont(font7)
        self.ppuidLabel.setStyleSheet(u"color: rgb(255, 255, 255);")

        self.gridLayout.addWidget(self.ppuidLabel, 3, 0, 1, 1)
        ...
        self.saveSettingsBtn.setFont(font8)
...
"}")
        ...
        self.gridLayout.addWidget(self.saveSettingsBtn, 11, 2, 1, 1)
        ...
        self.versionLabel.setFont(font7)
        ...
        self.regionLabel.setFont(font7)
        self.regionLabel.setStyleSheet(u"color: rgb(255, 255, 255);")

        self.gridLayout.addWidget(self.regionLabel, 4, 0, 1, 1)
        ...
        self.ppuidInput.setFont(font6)
        self.ppuidInput.setStyleSheet(u"color: rgb(255, 255, 255);")
        self.ppuidInput.setReadOnly(True)

        self.gridLayout.addWidget(self.ppuidInput, 3, 1, 1, 1)

        self.ppuidBtn = QPushButton(self.settingsAdjustment)
        self.ppuidBtn.setObjectName(u"ppuidBtn")
        self.ppuidBtn.setMinimumSize(QSize(150, 30))
        self.ppuidBtn.setMaximumSize(QSize(150, 30))
        self.ppuidBtn.setFont(font8)
        self.ppuidBtn.setCursor(QCursor(Qt.PointingHandCursor))
        self.ppuidBtn.setToolTipDuration(-1)
        self.ppuidBtn.setStyleSheet(u"QPushButton{\n"
"	color: rgb(255, 255, 255);\n"
"	border: none;\n"
"	border-radius: 15px;\n"
"}\n"
...
"")
        ...
        self.gridLayout.addWidget(self.ppuidBtn, 3, 2, 1, 1)
        ...
        self.usernameInput.setFont(font6)
        ...
        self.shardLabel.setFont(font7)
        self.shardLabel.setStyleSheet(u"color: rgb(255, 255, 255);")

        self.gridLayout.addWidget(self.shardLabel, 6, 0, 1, 1)
...
" Include (#)", None))
        ...
        self.ppuidInput.setText(QCoreApplication.translate("MainWindow", u"Click Generate", None))
#if QT_CONFIG(tooltip)
        self.ppuidBtn.setToolTip("")
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(statustip)
        self.ppuidBtn.setStatusTip("")
#endif // QT_CONFIG(statustip)
#if QT_CONFIG(whatsthis)
        self.ppuidBtn.setWhatsThis("")
#endif // QT_CONFIG(whatsthis)
        self.ppuidBtn.setText(QCoreApplication.translate("MainWindow", u"Generate \n"
" PPUID", None))
